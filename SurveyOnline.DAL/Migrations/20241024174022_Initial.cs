    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Surveys_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyTag", x => new { x.SurveysId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_SurveyTag_Surveys_SurveysId",
                        column: x => x.SurveysId,
                        principalTable: "Surveys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SurveyTag_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccessibleSurveysId = table.Column<Guid>(type: "uuid", nullable: false),
                    AccessibleUsersId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyUser", x => new { x.AccessibleSurveysId, x.AccessibleUsersId });
                    table.ForeignKey(
                        name: "FK_SurveyUser_AspNetUsers_AccessibleUsersId",
                        column: x => x.AccessibleUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SurveyUser_Surveys_AccessibleSurveysId",
                        column: x => x.AccessibleSurveysId,
                        principalTable: "Surveys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedSurveyId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Surveys_TopicId",
                table: "Surveys",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyTag_TagsId",
                table: "SurveyTag",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyUser_AccessibleUsersId",
                table: "SurveyUser",
                column: "AccessibleUsersId");
        }
